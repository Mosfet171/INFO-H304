...
int main (int argc, char** argv)
{
  ...
  /*  if (argc == 1){
    ...
    string indexname = string("uniprot_sprot.fasta")+string(".pin"); //argv[1] +string(".pin");
    ...
    */
    ...
    string sequencename =  string("wesh") + string(".psq"); //argv[1] + string(".psq");
    ...
    string headername =  string("uniprot_sprot.fasta") + string(".phr"); //argv[1] + string(".phr");
